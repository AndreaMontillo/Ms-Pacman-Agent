...
import pacman.entries.pacman.MyPacman_minmax;
...
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
		//*/
                int iterazioni = 50;
                exec.runExperiment(new MyPacman_minmax(), new AggressiveGhosts(), 10);
                
                
//                int iterazioni = 50;
//                String[] lista_score = new String[iterazioni];
//                
//                int s = 0;
//                for(int i=0; i<iterazioni; i++){
//                    System.out.println("\n\nNuova partita: " + i);
//                    s = exec.runGameTimed(new MyPacman_minmax(),new AggressiveGhosts(),visual);
//                    lista_score[i] = Integer.toString(s) + ",";
//                }
//                
//                System.out.println("Lista score: " + Arrays.toString(lista_score));
//                String csv = String.join("", lista_score);
//                
//                java.io.File f = new java.io.File("risultati.csv");
//                try {
...
//                System.out.println("\n------------ FINE VALUTAZIONE ---------------");
    ...
    public double runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
		...
		Game game;
                ...
                String[] lista_score = new String[trials];
                String[] lista_livelli = new String[trials];
		...
		for(int i=0;i<trials;i++)
		{
			...
			while(!game.gameOver())
			{
		        game.advanceGame(pacManController.getMove(game.copy(),DELAY-2),
		        		ghostController.getMove(game.copy(),DELAY-2));
			}
			
			avgScore+=game.getScore();
			System.out.println(i+"\t"+game.getScore());
                        lista_score[i] = Integer.toString(game.getScore()) + ",";
                        lista_livelli[i] = Integer.toString(game.getCurrentLevel()) +",";
		...
		System.out.println(avgScore/trials);
                ...
                System.out.println("Lista score: " + Arrays.toString(lista_score));
                String csv = String.join("", lista_score);
                String csv2 = String.join("", lista_livelli);
	 ...
	 * @param visual Indicates whether or not to use visuals
     */
    public int runGameTimed(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,boolean visual)
	{
		Game game=new Game(0);
		...
		while(!game.gameOver())
		{
			...
			catch(InterruptedException e)
			{
				e.printStackTrace();
                        ...
                        game.advanceGame(pacManController.getMove(game, DELAY-2),ghostController.getMove());	   
		...
		ghostController.terminate();
                ...
                System.out.println("\nFINE");
                System.out.println("Livello: " + game.getCurrentLevel());
                System.out.println("Punteggio: " + game.getScore());
